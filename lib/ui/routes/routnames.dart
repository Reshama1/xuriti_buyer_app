...
import 'package:xuriti/ui/screens/reports_screens/transaction_ledger/ledger_invoice.dart';
...
import 'package:xuriti/companyList/screen/wrapper.dart';
...
import '../screens/kyc_screens/residence_proof.dart';
    ...
    switch (settings.name) {
      ...
      case '/login':
        return MaterialPageRoute(
            builder: (_) => const LoginScreen(isFromPushNotification: false));
      case '/signUp':
        return MaterialPageRoute(
            builder: (_) => const SignUpScreen(
                  navigatedFromSignupGoogleButtonTapped: false,
                ));
      case '/home':
      ...
      case '/upcomingDetails':
        return MaterialPageRoute(
            builder: (_) => UpcomingDetails(
                  invoiceId: (settings.arguments as String),
                ));
      case '/savemoreDetails':
        Invoice? invoice = settings.arguments as Invoice;
        return MaterialPageRoute(
          builder: (_) => SavemoreDetails(
            invoice: invoice,
          ),
        );
      case '/paynow':
      ...
      // case '/forgetPassword':
      //   bool navigationFor = (settings.arguments as bool);
      //   return MaterialPageRoute(
      //       builder: (_) => ForgetPasswordScreen(
      //             navigatedForPassword: navigationFor,
      //           ));
      ...
      case '/residenceProof':
        return MaterialPageRoute(builder: (_) => const ResidenceProof());
      case '/ownershipProof':
