...
class TextStyles {
  ...
  static TextStyle textStyle() =>
      textStyle12(weight: FontWeight.w600, size: 16.5);
  ...
  //     fontStyle: FontStyle.normal,
  //     fontSize: 16.5);
  static textStyle12({FontWeight? weight, double? size}) => TextStyle(
      color: Colors.white,
  ...
  static const textStyle28 = TextStyle(
      ...
      fontStyle: FontStyle.normal,
      fontSize: 18.0);
  static textStyle24({Color? color}) => TextStyle(
  ...
  static const textStyle354 = TextStyle(
  ...
  static const textStyle27 = TextStyle(
      ...
      fontStyle: FontStyle.normal,
      fontSize: 10.0);
  static textStyle25([Color? color]) => TextStyle(
...
class Colours {
  ...
  static const fillColor = Color.fromRGBO(230, 229, 234, 1);
