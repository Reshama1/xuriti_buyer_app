...
class _CNInvoicesState extends State<CNInvoices> {
  ...
  Widget build(BuildContext context) {
    ///  Sort invoices Date wise Pending, Confirmed and remaining
      ...
      builder: (context, constraints) {
        ...
        return Padding(
          ...
          child: Container(
            ...
            child: Obx(
              () {
                List<Invoice?>? creditNoteInvoices = transactionManager
                    .invoices?.value?.invoice
                    ?.where(
                        (element) => element.invoiceType?.toLowerCase() == "cn")
                    .toList();
                    ...
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: const ConstantText(
                          text: all_credit_note_invoices,
                          style: TextStyles.textStyle38,
                        ),
                      ),
                    ),
                    (creditNoteInvoices?.isEmpty ?? true)
                        ? Column(
                            children: [
                              Padding(
                                ...
                                SliverList(
                                  ...
                                  ((context, index) {
                                    return PendingCNInvoiceWidget(
                                      ...
                                      maxHeight: maxHeight,
                                      isOverdue: false,
                                      fullDetails: creditNoteInvoices?[index],
                                    );
                                  }),
                                  childCount: creditNoteInvoices?.length ?? 0,
                                )),
                                SliverToBoxAdapter(
